        ...
        migrations.CreateModel(
            ...
            fields=[
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.MinLengthValidator(
                                8, "Account number must be at least 8 characters"
                            ),
                            django.core.validators.MaxLengthValidator(
                                50, "Account number cannot exceed 50 characters"
                            ),
                        ],
                    ),
                ),
                ...
                (
                    "processed",
                    models.BooleanField(
                        default=False, help_text="Whether the refund has been processed"
                    ),
                ),
                (
                    "processed_at",
                ...
                (
                    "user_agent",
                    models.TextField(
                        blank=True, help_text="User agent string of the requester"
                    ),
                ),
            ],
            options={
